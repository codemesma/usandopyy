...
class ViewQuizListByCategory(ListView):
    model = Quiz
    template_name = 'view_quiz_category_en.html'
...
class QuizUserProgressView(TemplateView):
    template_name = 'progress_en.html'
...
class QuizTake(FormView):
    ...
    template_name = 'question_en.html'
    result_template_name = 'result_en.html'
    single_complete_template_name = 'single_complete_en.html'
