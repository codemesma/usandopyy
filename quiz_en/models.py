...
class Progress(models.Model):
    ...
    """
    user = models.OneToOneField(settings.AUTH_USER_MODEL, related_name='user_en', verbose_name=_("User"), on_delete=models.CASCADE)
...
class Sitting(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL,related_name='user_sitting', verbose_name=_("User"), on_delete=models.CASCADE)
